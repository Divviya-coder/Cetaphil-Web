            ...
            >
                ...
                {common_data.length != 0 ?
                    <div className='headerLand'>
                        ...
                        <label className='headerTextLand'>{common_data[0].Adjacency_header.split(" ")[0]}&nbsp;&nbsp;:&nbsp;&nbsp;</label>
                        <label className='headerAvatarLand'>{common_data[0].Adjacency_header.split(" ")[1][0]}</label>
                        <label className='headerTextLand'>&nbsp;&nbsp;{common_data[0].Adjacency_header.split(" ")[1]} </label>

            ...
            <LinearGradient colors={['#16529a', '#0c9ddc', '#007cc6']}
                ...
                {common_data.length != 0 ?
                    <View style={orientation == "POTRAIT" ? styles.headerPotr : styles.headerLand}>
                        ...
                        <Text style={orientation == "POTRAIT" ? styles.headerTextPotr : styles.headerTextLand}>{common_data[0].Adjacency_header.split(" ")[0]}&nbsp;&nbsp;:&nbsp;&nbsp;</Text>
                        <Text style={orientation == "POTRAIT" ? styles.headerAvatarPotr : styles.headerAvatarLand}>{common_data[0].Adjacency_header.split(" ")[1][0]}</Text>
                        <Text style={orientation == "POTRAIT" ? styles.headerTextPotr : styles.headerTextLand}>&nbsp;&nbsp;{common_data[0].Adjacency_header.split(" ")[1]} </Text>
                ...
                parameter_creteria.length != 0 ?
                    ...
                    <LinearGradient colors={['#f0f1f2', '#f0f1f2', '#f0f1f2']} style={styles.bgStyle}>
                        ...
                        <View style={styles.secondBg}>
                            {
                                parameter_creteria.filter((e) => e.parameter_id == 4).map((e) => (

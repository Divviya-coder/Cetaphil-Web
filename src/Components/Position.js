...
import { Button, Text, View, Image, TextInput, StatusBar, Pressable, TouchableOpacity, Alert, ScrollView } from 'react-native'
...
function Position({ navigation }) {
        ...
        db.transaction((tx) => {
            tx.executeSql(
                ...
                (tx, results) => {
                    ...
                    // console.log(temp, 'selected_store_shelf')
                }
            );
        });
    }, [])
    ...
    console.log(criterial_post, 'position')
            ...
            <LinearGradient colors={['#16529a', '#0c9ddc', '#007cc6']}
                ...
                {common_data.length != 0 ?
                    <View style={orientation == "POTRAIT" ? styles.headerPotr : styles.headerLand}>
                        ...
                        <Text style={orientation == "POTRAIT" ? styles.headerTextPotr : styles.headerTextLand}>{common_data[0].Possition_header.split(" ")[0]}&nbsp;&nbsp;:&nbsp;&nbsp;</Text>
                        <Text style={orientation == "POTRAIT" ? styles.headerAvatarPotr : styles.headerAvatarLand}>{common_data[0].Possition_header.split(" ")[1][0]}</Text>
                        <Text style={orientation == "POTRAIT" ? styles.headerTextPotr : styles.headerTextLand}>&nbsp;&nbsp;{common_data[0].Possition_header.split(" ")[1]} </Text>
